...
local function v__cross(a, b)
    if(v__isZero(a) or v__isZero(b)) then return vec3() end
    return vec3(
        a.y*b.z - a.z*b.y,
        a.z*b.x - a.x*b.z,
        a.x*b.y - a.y*b.x
...
local function v__fromSpherical(radius, theta, phi)
...
-- other
mti.fromSpherical = v__fromSpherical
mti.split = v__split
